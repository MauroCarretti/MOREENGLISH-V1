...
class Course_Filter extends Widget_Base {
    ...
    public function get_name() {
        return 'edublink-ms-course-filter';
    }
    ...
    public function get_title() {
        return __( 'Course Filter Sidebar(MasterStudy)', 'edublink-core' );
    }
	...
	public function get_keywords() {
		return [ 'edublink', 'query', 'courses', 'lms', 'master study', 'master', 'study', 'masterstudy', 'archive', 'loop','filter', 'sidebar filter', 'filter sidebar' ];
	}
    ...
    protected function _register_controls() {
        $filter_options = apply_filters( 'edublink_course_filter_options', [
            ...
            'ms_status'  => __( 'Status', 'edublink-core' ),
            'ms_level'   => __( 'Level', 'edublink-core' ),
            'ms_price'   => __( 'Price', 'edublink-core' ),
            'ms_rating'  => __( 'rating', 'edublink-core' )
        ] );
        ...
        $this->add_control(
            ...
            [
                'type'               => Controls_Manager::TEXT,
                'label'              => __( 'Price Label Text', 'edublink-core' ),
                'default'            => __( 'Price', 'edublink-core' ),
                'condition'          => [
        ...
        $this->add_control(
            ...
            [
                'type'               => Controls_Manager::TEXT,
                'label'              => __( 'Status Label Text', 'edublink-core' ),
                'default'            => __( 'Status', 'edublink-core' ),
                'condition'          => [
        ...
        $this->add_control(
            ...
            [
                'type'               => Controls_Manager::TEXT,
                'label'              => __( 'Rating Label Text', 'edublink-core' ),
                'default'            => __( 'Rating', 'edublink-core' ),
                'condition'          => [
    ...
    protected function render() {
        ...
        $args = Filter::query( $filtered_category, null, $settings );
            ...
            echo '<div ' . $this->get_render_attribute_string( 'wrapper' ) . '>';
                ...
                echo '<div class="edublink-col-lg-9 filter-course-column">';
                    echo '<div class="filtered-courses">';
                        ...
                        $args = apply_filters( 'edublink_ms_course_filter_args', $args );
