...
class Course_Filter extends Widget_Base {
    ...
    public function get_name() {
        return 'edublink-lp-course-filter';
    }
    ...
    public function get_title() {
        return __( 'Course Filter Sidebar(LearnPress)', 'edublink-core' );
    }
	...
	public function get_keywords() {
		return [ 'edublink', 'query', 'courses', 'lms', 'lp', 'learnpress', 'archive', 'loop','filter', 'sidebar filter', 'filter sidebar' ];
	}
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => [ 'category', 'lp_level', 'lp_price' ],
                'multiple'      => true,
    ...
    protected function render() {
        ...
        $settings['orderby_types'] = apply_filters( 'edublink_courses_orderby', array(
            ...
            'lp_popular'      => __( 'Popular', 'edublink-core' ),
            'lp_featured'     => __( 'featured', 'edublink-core' ),
        ) );
            ...
            echo '<div ' . $this->get_render_attribute_string( 'wrapper' ) . '>';
                ...
                echo '<div class="edublink-col-lg-9 filter-course-column">';
                    echo '<div class="filtered-courses">';
                        ...
                        $args = apply_filters( 'edublink_lp_course_filter_args', $args );
