...
$course_details_style = edublink_set_value( 'ss_course_details_style', 1 );
$course_details_sidebar = edublink_set_value( 'ss_course_details_sidebar_status', true );
$course_sidebar_sticky = edublink_set_value( 'ss_course_details_sidebar_sticky', true );
...
// edublink_ss_course_details_header( $course_details_style );
		...
		echo '<div class="edublink-row">';
			...
			if ( $course_details_sidebar ) :
				echo '<div class="' . esc_attr( $course_sidebar_class ) . ' ' . apply_filters( 'courese_details_sidebar_columnn', 'edublink-col-lg-4' ) . '">';
					// edublink_ss_course_content_sidebar();
				echo '</div>';
			endif;
		echo '</div>';
	echo '</div>';
