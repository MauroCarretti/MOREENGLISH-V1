...
$course_details_style = edublink_set_value( 'ld_course_details_style', 1 );
$course_details_sidebar = edublink_set_value( 'ld_course_details_sidebar_status', true );
$course_sidebar_sticky = edublink_set_value( 'ld_course_details_sidebar_sticky', true );
...
edublink_ld_course_details_header( $course_details_style );

echo '<div class="edublink-course-details-page ld-course-single-page eb-course-single-style-' . esc_attr( $course_details_style ) . '">';
	echo '<div class="site-content-inner' . esc_attr( apply_filters( 'edublink_container_class', ' edublink-container' ) ) . '">';
		...
		echo '<div class="' . esc_attr( $siebar_main_content ) . ' ' . apply_filters( 'courese_details_columnn', $course_details_column ) . '">';
			echo '<div class="eb-course-details-page-content">';
				if ( $course_details_style == '4' ) :
					get_template_part( 'learndash/custom/single/style', '4' );
				endif;
		...
		if ( $course_details_sidebar ) :
			echo '<div class="' . esc_attr( $course_sidebar_class ) . ' ' . apply_filters( 'courese_details_sidebar_columnn', 'edublink-col-lg-4' ) . '">';
				edublink_ld_course_content_sidebar();
			echo '</div>';
		endif;
