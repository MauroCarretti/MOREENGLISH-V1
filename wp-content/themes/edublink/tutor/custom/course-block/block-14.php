...
echo '<div id="inline-tooltip-' . esc_attr( $block_data['uniqid'] ) . '" class="eb-tl-course edublink-course-' . esc_attr( $block_data['style'] ) . '-hover">';
    echo '<div class="inner">';
        echo '<div class="content">';
            if ( $block_data['cat_item'] ) :
                echo '<span class="course-level">' . wp_kses_post( $block_data['cat_item'] ) . '</span>';
            ...
            echo '<ul class="course-meta">';
                ...
                echo '<li class="course-meta-info duration">';
                    echo tutor_kses_html( $block_data['duration'] );
                echo '</li>';
            ...
            echo '<div class="button-group">';
                ...
                edublink_tutor_wishlist_icon( get_the_ID() );
            echo '</div>';
        echo '</div>';
    echo '</div>';
echo '</div>';