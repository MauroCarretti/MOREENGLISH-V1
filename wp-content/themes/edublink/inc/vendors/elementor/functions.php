...
if ( ! class_exists( 'EduBlink_Elementor_Extensions' ) ) :
    final class EduBlink_Elementor_Extensions {

        private static $_instance = null;

        public function __construct() {
            add_filter( 'edublink_generate_post_builder', array( $this, 'render_post_builder' ), 10, 2 );
        }
...
if ( did_action( 'elementor/loaded' ) ) :
    ...
    EduBlink_Elementor_Extensions::instance();
endif;