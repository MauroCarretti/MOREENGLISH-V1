...
<div class="event_register_area eb-tp-event-register-popup">
    ...
    <form name="event_register" class="event_register" method="POST">
		...
		<?php } else { ?>
            <div class="event_auth_form_field">
                <label for="event_register_qty"><?php _e( 'Quantity', 'edublink' ) ?></label>
		...
		<?php if ( !$event->is_free() ) {
			...
			<?php } else {
				wpems_print_notice( 'error', esc_html__( 'There are no payment gateway available. Please contact administrator to setup it.', 'edublink' ) );
			}
		} ?>
        ...
        <div class="event_register_foot">
            ...
            <button class="edu-btn btn-medium event_register_submit event_auth_button" <?php echo $payments ? '' : 'disabled="disabled"' ?>><?php _e( 'Register Now', 'edublink' ); ?></button>
        </div>
